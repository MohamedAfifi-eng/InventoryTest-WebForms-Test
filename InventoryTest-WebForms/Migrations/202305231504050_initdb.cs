        ...
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        InvoiceId_FK = c.Int(nullable: false),
                        ItemId_FK = c.Int(nullable: false),
                        UintPrice = c.Single(nullable: false),
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        ClientId_FK = c.Int(nullable: false),
                        CreateTime = c.DateTime(nullable: false),
                        InvoiceValue = c.Single(nullable: false),
                        DiscountValue = c.Single(nullable: false),
                        DiscountPercentage = c.Single(nullable: false),
                        InvoiceNetValue = c.Single(nullable: false),
                        Client_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                ...
                c => new
                    {
                        ...
                        AvailableUnits = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id);
